...
from crypto.designs.nonlinear.ciphercomponents import choice, rotate_left, rotate_right
...
#--------- countermeasures against micks attack        
...
def test_permutation2_invert_permutation2():
    data = bytearray(16)
    data[0] = 1
    _data = data[:]
    permutation2(data)
