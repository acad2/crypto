...
def shift_and_mix(a, b, c, d, r1, r2, r3):    # 7 instructions = 
    a, b, c, d = mix_columns(a, b, c, d)            # 4 instructions    
...
def round_function(a, b, c, d, round_number): # 41 instructions (not counting loop)            
    ...
    a, b, c, d = shift_and_mix(a, b, c, d, 1, 2, 3)              # 9     
    a, b, c, d = shift_and_mix(a, b, c, d, 4, 8, 12)              # 9     
    a, b, c, d = shift_and_mix(a, b, c, d, 16, 32, 48)              # 9     
    return a, b, c, d
