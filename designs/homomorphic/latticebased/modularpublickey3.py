import crypto.designs.homomorphic.latticebased.modular3 as secretkey
...
def encrypt(message, public_key, r_size=32, n=secretkey.N):
...
def test_encrypt_decrypt():
    ...
    test_asymmetric_encrypt_decrypt("modularpublickey3", generate_keypair, encrypt, decrypt, plaintext_size=32, iterations=10000)
