import crypto.designs.homomorphic.latticebased.squaremod2 as secretkey
...
def test_encrypt_decrypt():
    ...
    test_asymmetric_encrypt_decrypt("squaremodpublickey", generate_keypair, encrypt, decrypt, plaintext_size=32, iterations=10000)
